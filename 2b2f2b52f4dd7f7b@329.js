...
await d3.csv("https://raw.githubusercontent.com/MariaGAlarcon/range-OA-implementation/main/RangeOAimplementation.csv")
)}
...
await d3.csv("https://raw.githubusercontent.com/MariaGAlarcon/global-OA-stocktake-data/refs/heads/main/OA_global_stocktake_data.csv")
)}
...
function _countryDetails(selectedCountry,html,$0,componentNames)
{
  ...
  return html`
    <div style="margin-top: 20px; padding: 15px; border: 1px solid #ddd; border-radius: 5px;">
      <div style="display: flex; justify-content: space-between; align-items: start;">
        ...
        <button style="padding: 5px 10px;" onclick=${() => { $0.value = null; }}>
          ✕ Close
        </button>
      </div>
  ...
  <div style="font-family: sans-serif; max-width: 1200px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 40px;">
      ...
      <p style="margin-top: 0; margin-bottom: 20px; color: #444; font-size: 16px; line-height: 1.6;">
        These interactive visualizations shows which countries are implementing ocean accounting initiatives worldwide. The maps below show both the range of implementation (how many components) and the types of components each country has implemented, including:
      </p>
    ...
    <div style="margin-bottom: 20px;">
      ...
      <p style="margin-top: 0; margin-bottom: 20px; color: #444; font-size: 16px; line-height: 1.6;">
        This map shows countries implementing ocean accounting by component type. Countries are color-coded to show which specific ocean accounting components they have implemented—from Environmental Assets and Ocean Economy accounts to Flows to Environment and Governance frameworks.
      </p>
      <p style="margin-top: 0; margin-bottom: 20px; color: #444; font-size: 16px; line-height: 1.6;">
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("countryDetails")).define("countryDetails", ["selectedCountry","html","mutable selectedCountry","componentNames"], _countryDetails);
